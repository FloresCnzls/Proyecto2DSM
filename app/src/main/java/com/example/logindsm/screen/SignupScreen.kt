...
@Composable
fun SignupScreen(modifier: Modifier = Modifier,navHostController: NavHostController, authViewModel: AuthViewModel = viewModel()){
    ...
    Column (
        ...
        Button(onClick = {
            ...
            Text(text = if(isLoading) "Creando cuenta" else "Registrarse", fontSize = 22.sp)
        }
    }
}
